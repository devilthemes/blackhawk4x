  ...
  <div class="form-group row {if !empty($field.errors)}has-error{/if}">
    ...
    <div class="col-md-6{if ($field.type === 'radio-buttons')} form-control-valign{/if}">
      ...
      {elseif $field.type === 'checkbox'}
        ...
        <div class="checkbox">
         <label> <input name="{$field.name}" type="checkbox" value="1" {if $field.value}checked="checked"{/if} {if $field.required}required{/if}>
      ...
      {elseif $field.type === 'password'}
        ...
        <div class="input-group js-parent-focus">
          <input
            class="form-control btn js-child-focus js-visible-password"
            name="{$field.name}"
            type="password"
            value=""
